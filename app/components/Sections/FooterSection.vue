...
<template>
  <footer class="bg-emerald-900 dark:bg-emerald-950 text-white py-12">
      ...
      <div class="grid md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <ul class="space-y-2 text-gray-400">
            <li>
              <span class="mr-1 inline-block w-20">{{ t('footer.phone') }} 2:</span>
              <a :href="`tel:${config.company.phone2.replaceAll(' ', '')}`" class="text-gray-400 hover:text-white">{{ config.company.phone2 }}</a>
            </li>
            <li>
